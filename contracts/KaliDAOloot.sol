...
/// @notice Modern and gas-optimized ERC-20 with pausing.
...
contract KaliDAOloot is KaliOwnable {
    /*///////////////////////////////////////////////////////////////
                            EVENTS
    //////////////////////////////////////////////////////////////*/
    ...
    function init(
        ...
        if (accounts_.length != loots_.length) revert NoArrayParity();
