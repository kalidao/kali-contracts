...
contract KaliDAOx1155 is ERC1155Votes, Multicallable, NFTreceiver, ReentrancyGuard {
    /// -----------------------------------------------------------------------
    /// EVENTS
    /// -----------------------------------------------------------------------
    ...
    function init(
        ...
        if (voters_.length != amounts_.length) revert NoArrayParity();
...
contract KaliDAOxFactory1155 is Multicallable {
    ...
    KaliDAOx1155 internal immutable kaliMaster;

    constructor(KaliDAOx1155 kaliMaster_) payable {
    ...
    function deployKaliDAO(
        ...
        KaliDAOx1155 kaliDAO = KaliDAOx1155(
